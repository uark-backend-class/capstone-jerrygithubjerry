...
export const getAllAppointments = async (req, res) => {
  ...
  const dbResponse = await db.query(`SELECT appointments.appointment_id, appointments.time,
    appointments.service, appointments.date, appointments.hygienist_id, appointments.notified, 
    appointments.updated, patients.patient_name, patients.patient_email, hygienists.hygienist_id, hygienists.hygienist_name
